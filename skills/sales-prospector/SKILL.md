...
When to use:
- A CRM view, a name list, "who should I email", or /sales-prospector.

Input:
- Accounts: <CRM view, list, or URLs>
- ICP: <who we sell to, one paragraph>
- Offer: <what we sell, one sentence>
- Voice samples: <paste 1-2 emails that sound like me, or "plain">

Access:
- Web, CRM if connected, LinkedIn / email only for research and drafts.
...
2. Contacts + evidence
3. Drafts (email + LinkedIn)
4. Who to skip and why
5. The one account I would send first if you say yes
